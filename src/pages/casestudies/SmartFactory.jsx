      ...
      <section className="relative min-h-[85vh] overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 pt-40 pb-28 grid lg:grid-cols-2 gap-20">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-semibold text-bg-primary leading-tight">
            ...
            <p className="mt-8 max-w-xl text-bg-primary/85 text-lg leading-relaxed">
              ...
              lines, reduce downtime, and increase overall manufacturing efficiency
              with intelligent IoT and robotics integration.
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-12 gap-12 items-start relative z-10">
            ...
            <div className="lg:col-span-8 justify-center">
              <p className="text-lg leading-relaxed text-primary/80">
                This smart factory project integrates cutting-edge automation technology
                across production lines, using robotics, AI-powered predictive
                maintenance, and IoT sensors to streamline operations, reduce waste,
                and maximize output while maintaining quality standards.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-20">
          ...
          >
            ...
            <p className="leading-relaxed text-bg-primary/85 text-lg">
              ...
              algorithms to optimize production throughput, minimize downtime, and
        ...
        <div>
          ...
          <div className="grid md:grid-cols-3 gap-12">
            {[
              ...
              >
                <p className="text-4xl font-semibold text-accent">{item.value}</p>
