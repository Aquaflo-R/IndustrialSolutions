...
export default function OilGasIndustry() {
  const products = [
    {
      title: "Pipeline Integrity Monitoring Systems",
      description:
        "IoT-based monitoring solutions ensuring real-time pipeline leak detection, safety, and operational reliability in oil & gas.",
    },
    {
      title: "Refinery Energy Optimization Platforms",
      description:
        "Advanced energy management systems reducing fuel consumption and carbon footprint while improving refinery operational efficiency.",
    },
    {
      title: "Gas Compression And Storage Solutions",
      description:
        "High-efficiency compressors and storage systems designed to ensure reliable supply and safety for gas operations.",
    },
    {
      title: "Emissions Reduction And Control Systems",
      description:
        "Integrated solutions reducing CO₂, NOx, and methane emissions while complying with environmental regulations in operations.",
    },
    {
      title: "Hybrid Renewable Power Integration",
      description:
        "Solar and wind hybrid systems supplying clean, reliable power to oil & gas facilities, reducing fossil fuel reliance.",
    },
    {
      title: "Safety And Emergency Response Systems",
      description:
        "Automated safety systems for rapid emergency response, ensuring worker protection and operational reliability in oil & gas plants.",
    },
  ];
      ...
      <section className="relative min-h-[65vh] flex items-center justify-center overflow-hidden bg-linear-to-br from-primary via-secondary to-secondary">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-bg-primary/80 mb-10 leading-relaxed">
            Innovative solutions for exploration, refining, and distribution,
        ...
        <div className="relative max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <p className="font-lato text-secondary leading-relaxed max-w-md">
              Oil & Gas operations face high energy demands, safety risks,
              emissions regulations, and the need for sustainable operations.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="relative bg-white rounded-2xl shadow-lg p-6 pl-16">
              <div className="absolute -left-6 top-6 w-12 h-12 rounded-full bg-primary flex items-center justify-center">
                <Droplet className="text-accent" size={22} />
              </div>
              <h4 className="font-raleway font-semibold text-primary">
                Pipeline Integrity
              </h4>
              <p className="text-sm text-secondary-dark">
                Ensuring safe, reliable, and efficient flow with advanced
                monitoring.
              </p>
            </div>
            ...
            <div className="relative bg-white rounded-2xl shadow-lg p-6 pl-16 ml-6">
              ...
              <p className="text-sm text-secondary-dark">
                Optimizing energy, output, and reducing operational costs.
              </p>
            </div>
            ...
            <div className="relative bg-white rounded-2xl shadow-lg p-6 pl-16 ml-12">
              ...
              <p className="text-sm text-secondary-dark">
                Hybrid power and renewable integration for reduced environmental
                impact.
              </p>
            </div>
          </motion.div>
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          <div className="text-center mb-24">
            ...
            <p className="mt-4 max-w-2xl mx-auto font-lato text-accent">
              Comprehensive Oil & Gas solutions integrating pipeline monitoring,
              refinery efficiency, hybrid energy, and emissions reduction.
            </p>
          </div>
          ...
          <div className="relative hidden md:grid grid-cols-3 gap-20 items-start">
            ...
            <Card
              ...
              delay={0}
              desc="Real-time monitoring and leak detection for safer operations."
            />
            <Card
              Icon={Flame}
              ...
              delay={0.1}
              offset
              desc="Energy management and process optimization for refineries."
            />
            <Card
              Icon={BatteryCharging}
              title="Hybrid Energy Solutions"
              delay={0.2}
              desc="Renewable power integration to reduce fossil fuel dependency."
            />
          </div>
