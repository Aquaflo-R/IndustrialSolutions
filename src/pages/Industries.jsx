...
export default function Industries() {
  ...
  return (
    <div className="min-h-screen font-raleway">
      {/*Hero*/}
      <section className="relative min-h-[70vh] sm:min-h-[75vh] md:min-h-[95vh]  flex items-center overflow-hidden bg-primary sm:mt-2 md:-mt-1 pt-20">
        {/* BACKGROUND */}
        <motion.div
        ...
        {/* GLOWS */}
        <div className="absolute top-2 sm:top-6 -left-16 sm:-left-24 w-32 h-32 sm:w-48 sm:h-48 rounded-full bg-accent/15 animate-pulse" />
        ...
        {/* CONTENT */}
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-8 lg:px-12 text-center pt-12 sm:pt-0 pb-12 sm:pb-16 md:pb-0 ">
          <motion.div
          ...
          >
            ...
            <h1 className="text-[2.4rem] sm:text-[3.2rem] md:text-[4.8rem] font-bold text-bg-primary leading-[1.15] sm:leading-tight mb-5 sm:mb-6 ">
              Powering Industries <br className="hidden sm:block" />
              with Solar & Wind Energy
            </h1>

            <p className="text-base sm:text-lg text-bg-primary/80 font-lato mb-7 sm:mb-8 max-w-xl mx-auto">
      ...
      <section className="relative overflow-hidden bg-[#F6FBF9] py-20  md:py-24 pb-28 md:pb-36 font-lato max-sm:py-12">
        ...
        {/* giant text */}
        <h2
          className=" absolute inset-0 flex items-center justify-center text-[5rem] sm:text-[8rem] md:text-[15rem] font-extrabold text-transparent stroke-[1px] stroke-primary/10 pointer-events-none
        "
        >
          ENERGY
        </h2>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-8 lg:px-12 grid lg:grid-cols-2 gap-12 md:gap-14 items-center">
          ...
          <motion.div
            ...
            className="space-y-6 "
          >
            <span className="inline-block px-4 py-1 text-xs uppercase tracking-widest bg-primary/10 text-primary rounded-full">
              Incredible Facts
            </span>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8 md:gap-12">
            {industries.map((industry, index) => (
              <motion.div
                ...
                "
              >
                <div className="absolute -top-6 left-1/2 -translate-x-1/2 w-12 h-12 rounded-full bg-secondary flex items-center justify-center text-white">
                  {industry.icon}
                </div>
