...
const Process = () => {
  return (
    <>
      ...
      <div id="SubsectionHero" className="w-full h-[30vw] ">
        <div className="w-full h-full flex items-center justify-center gap-10">
          ...
          <div className="w-[50%]">
            <p className="font-primary text-2xl text-primary">
      ...
      <div className="">
        <div className="relative min-h-screen bg-[radial-gradient(circle_at_20%_20%,#c7d2fe,transparent_60%),radial-gradient(circle_at_80%_80%,#fbcfe8,transparent_60%)] ">
          <div className=" flex gap-10 p-10 ">
            <div className="sticky top-20 h-[15vw] w-[50%] pt-5">
              <h2 className="font-primary text-4xl font-bold text-primary mb-5">
                Our Approach
              </h2>
              <p className="font-secondary text-xl w-[40vw] pb-5">
            ...
            <div className="space-y-5  w-[50%] h-full">
      ...
      <div className="w-full h-[40vw] flex">
        <div className=" w-[50%] relative">
          <img
            className="absolute w-[30vw] top-20 rounded-2xl left-20 object-cover"
          ...
          />
          <img
            className="absolute w-[30vw] h-[20vw] top-60  rounded-2xl left-50 object-cover"
        ...
        <div className=" flex flex-col justify-center gap-3  w-[50%] pl-20">
