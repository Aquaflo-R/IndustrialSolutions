...
function Header() {
    ...
    return(
        <motion.nav
            ...
            className="fixed top-0 left-0 w-full bg-white z-50 border-b-2"
        >
            <div className=" mx-auto px-10 py-4 bg-white/70 flex rounded-full justify-between items-center">
                {/* Logo */}
                ...
                {open && (
                    ...
                    >
                        <div className="flex flex-col gap-4 px-6 py-6 text-base font-medium">
                            ...
                            <Link onClick={() => setOpen(false)} to="/process">Process</Link>
                            <Link onClick={() => setOpen(false)} to="/infrastructure">Infrastructure</Link>
                            <Link onClick={() => setOpen(false)} to="/caseStudies">Case Studies</Link>
